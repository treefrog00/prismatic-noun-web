          ...
          />
          {
            <div className="w-full max-w-4xl mx-auto bg-gray-800/80 rounded-lg shadow-xl p-6 border border-gray-700">
              <div className={`text-center text-gray-200 text-lg`}>
                <p className="mb-4">
                  A collection of spooky visual stories. The presentation is
                  somewhat similar to a visual novel, but the plotline is always
                  predetermined. Certain scenes are generated by a combination
                  of player input and AI.
                </p>
                <p className="mb-4">
